...
//                     var a = json.encode(cellValue.toJson());
...
//       var range = "'$sheetId'!B25:F25";
//       var values = [
//         ["10/8/2024", 'បាយកន្លែងកាងារ', '\$1.48', '៛6,000', 'USD', '\$4,061.77']
//       ];
//       var valueRange = sheet.ValueRange(
//         range: range,
//         values: values,
//       );
//       // Append the row to the sheet
//       var appendResponse = await sheetsApi.spreadsheets.values.append(
//         valueRange,
//         fildId,
//         range,
...
//       Map<dynamic, dynamic> cellFormat = {
//         "dataValidation": {
//           "condition": {
//             "type": "ONE_OF_RANGE",
//             "values": [
//               {"userEnteredValue": "='ព័ត៌មាន'!\$C\$3:\$C\$4"}
//             ]
//           },
//           "showCustomUi": true,
//           "strict": true
...
//         },
//         "effectiveValue": {"stringValue": "USD"},
//         "formattedValue": "USD",
//         "userEnteredFormat": {
//           "backgroundColor": {
//             "blue": 0.92156863,
...
//       var requests = [
//         sheet.Request(
//           repeatCell: sheet.RepeatCellRequest(
//             range: sheet.GridRange(
//               sheetId: 389962946,
...
//               endColumnIndex: 2,
//             ),
//             cell: sheet.CellData.fromJson(cellFormat),
//             fields: 'userEnteredFormat.textFormat',
//           ),
//         )
//       ];
//       var batchUpdateRequest = sheet.BatchUpdateSpreadsheetRequest(
//         requests: requests,
//         includeSpreadsheetInResponse: false,
//         responseIncludeGridData: false,
//       );
//       var batchResponse =
//           await sheetsApi.spreadsheets.batchUpdate(batchUpdateRequest, fildId);
//       print(batchResponse);
//     }
//   }
// }
